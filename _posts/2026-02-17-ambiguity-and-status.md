---
title: "아는 사람들 논문 소개: 저출산(AER)과 불확실성 해소(JET)"
categories:
  - PaperSummary
tags:
...
이 블로그의 최초 목적은 내가 모르는 새로운 연구를 찾아 간단히 기록하는 거다. 아는 사람 연구는 발표나 개인적인 대화를 통해 알게 되니까 굳이 여기 안적어도 되긴 하는데, 최근 **American Economic Review**와 **Journal of Economic Theory**에 지인들의 논문이 실렸는데, 샤라웃하는 차원에서 남겨둔다.
...
결과가 이미 정해졌지만 내가 아직 모르는 상황(예: 오늘 주식 장 마감 직후)에서, 사람들은 결과를 지금 당장 알고 싶어 할까, 아니면 나중에 알고 싶어 할까? 사건이 일어날 확률을 모르는 상태에서 확률을 얼마나 알고 싶어할까?

이 논문은 기존 연구들이 주로 다뤘던 '위험(Risk, 확률을 아는 경우)'을 넘어, *'모호성(Ambiguity, 확률조차 모르는 경우)'* 상황에서의 정보 확인 타이밍 선호를 실험적으로 확인했다.

사람들은 확률을 알 때(Risk) 결과를 미리 아는 것보다 확률을 모를 때(Ambiguity) 확률을 미리 알고 싶어하는 경향이 더 강했다. (Risk: 47% vs Ambiguity: 64%). 흥미롭게도 결과를 빨리 알기 위해 돈을 지불할 의향(Willingness to pay)은 매우 낮게 나타났다. "빨리 알면 좋긴 한데, 돈 낼 정도는 아님"이라는 태도다.
