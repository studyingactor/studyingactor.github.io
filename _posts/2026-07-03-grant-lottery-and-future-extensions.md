---
title: "연구비 심사에 '운'이 개입하는 게 합리적이라고? (+ 후속 연구자 모십니다)"
categories:
  - PaperSummary
tags:
  - grant allocation
...
우리는 흔히 심사 결과가 이상하면 심사위원의 태만이나 무능을 탓한다. 하지만 내 모형에서는 펀딩 기관이 지원자의 질(Quality)을 완벽하게 관찰할 수 있음에도 **'의도적으로' 추첨(Lottery) 요소를 도입하는 것이 최적**일 수 있음을 보여준다.
...
결국 펀딩 기관이 질적인 우수성뿐만 아니라 '참여도(지원자 수)'를 중요하게 여긴다면, 최상위권의 이탈을 막을 수 있는 아슬아슬한 선에서 적절히 '운'을 섞는 것이 합리적인 선택이 된다. (논문에서는 왜 지원자 수(와 그에 수반해서 나오는 성공확률)가 중요한지 말로만 설명했다...)
