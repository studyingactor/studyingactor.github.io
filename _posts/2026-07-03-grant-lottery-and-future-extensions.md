...
우리는 흔히 심사 결과가 이상하면 심사위원의 태만이나 무능을 탓한다. 그러니 지금까지는 대부분 어떻게 하면 심사를 더 잘 할 수 있을지 논의하거나, 심사를 잘 하기 어려우니 솔직히 포기하고 랜덤하게 뽑는 식으로 가자고 논의하는 식이었다. 

하지만 내 모형에서는 펀딩 기관이 지원자의 질(Quality)을 완벽하게 관찰할 수 있음에도 **'의도적으로' 추첨(Lottery) 요소를 도입하는 것이 최적**일 수 있음을 보여준다. (지원자의 질을 완벽하게 관찰할 수 있다는 가정에서, 로또는 $\delta$만큼의 펀딩을 High-quality 제안서에 할당하고, $1-\delta$만큼은 선정 안된 지원서 모두에서 랜덤하게 뽑는 걸로 모형화했다. 그럼 $\delta=1$이면 완벽한 능력주의, $\delta=0$이면 완전 추첨을 의미하게 된다.)
